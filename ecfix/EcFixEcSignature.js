// this is a test example replacement for bitcoincashjs-lib/src/ecsignature.js
...
var ecfixConfig = require('./EcFixConfig');

function ECSignature (r, s) {
  console.log("BBNV: IN ECSignature CONSTRUCTOR")
  if (ecfixConfig.isTypeforceEnabled()) {
